...
Проект написан на языке Python. В нейронной сети я использовала библиотеки TensorFlow, Keras и Numpy. Для создания телеграм-бота была использована библиотека Telebot.

<!-- Как пользоваться -->
## Как пользоваться

Чтобы воспользоваться моим ботом, просто добавьте его в Телеграме. Бот выложен в Heroku, а значит мне не нужно запускать его вручную для работы.
